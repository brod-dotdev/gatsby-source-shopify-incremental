...
export declare type Article = Node & {
    /**
...
export declare type MetafieldParentResource = Product | ProductVariant;
 ...
 */
export declare type Product = Node & HasMetafields & {
...
export declare type ArticleNodeFragment = Pick<Article, 'content' | 'contentHtml' | 'excerpt' | 'excerptHtml' | 'id' | 'publishedAt' | 'tags' | 'title' | 'handle' | 'url'> & {
    author: Pick<ArticleAuthor, 'bio' | 'email' | 'firstName' | 'lastName' | 'name'>;
    authorV2?: Maybe<Pick<ArticleAuthor, 'bio' | 'email' | 'firstName' | 'lastName' | 'name'>>;
    blog: Pick<Blog, 'id'>;
    image?: Maybe<Pick<Image, 'altText' | 'id' | 'src' | 'originalSrc'>>;
    seo?: Maybe<Pick<Seo, 'title' | 'description'>>;
};
export declare type BlogNodeFragment = Pick<Blog, 'id' | 'title' | 'handle' | 'url'>;
export declare type CollectionNodeFragment = Pick<Collection, 'description' | 'descriptionHtml' | 'handle' | 'id' | 'title' | 'updatedAt'> & {
    image?: Maybe<Pick<Image, 'altText' | 'id' | 'src' | 'originalSrc'>>;
    products: {
        edges: Array<{
            node: Pick<Product, 'id'>;
        }>;
    };
};
export declare type MetafieldNodeFragment = Pick<Metafield, 'description' | 'id' | 'key' | 'namespace' | 'value' | 'valueType' | 'createdAt' | 'updatedAt'>;
export declare type PageNodeFragment = Pick<Page, 'id' | 'handle' | 'title' | 'body' | 'bodySummary' | 'updatedAt' | 'createdAt' | 'url'>;
export declare type ProductVariantNodeFragment = Pick<ProductVariant, 'availableForSale' | 'compareAtPrice' | 'id' | 'price' | 'requiresShipping' | 'sku' | 'title' | 'weight' | 'weightUnit'> & {
    ...
    presentmentUnitPrices: {
        edges: Array<{
            node: Pick<MoneyV2, 'amount' | 'currencyCode'>;
        }>;
    };
    unitPrice?: Maybe<Pick<MoneyV2, 'amount' | 'currencyCode'>>;
    unitPriceMeasurement?: Maybe<Pick<UnitPriceMeasurement, 'measuredType' | 'quantityUnit' | 'quantityValue' | 'referenceUnit' | 'referenceValue'>>;
};
export declare type ProductNodeFragment = Pick<Product, 'availableForSale' | 'createdAt' | 'description' | 'descriptionHtml' | 'handle' | 'id' | 'onlineStoreUrl' | 'productType' | 'publishedAt' | 'tags' | 'title' | 'updatedAt' | 'vendor'> & {
    images: {
        edges: Array<{
            node: Pick<Image, 'id' | 'altText' | 'originalSrc'>;
        }>;
    };
    metafields: {
        edges: Array<{
    ...
    media: {
        edges: Array<{
            node: (Pick<ExternalVideo, 'alt' | 'mediaContentType'> & {
    ...
    variants: {
        edges: Array<{
            node: ProductVariantNodeFragment;
        }>;
    };
};
export declare type LoadArticlesQueryVariables = Exact<{
    first: Scalars['Int'];
    after?: Maybe<Scalars['String']>;
}>;
export declare type LoadArticlesQuery = {
    articles: {
        pageInfo: Pick<PageInfo, 'hasNextPage'>;
        edges: Array<Pick<ArticleEdge, 'cursor'> & {
            node: ArticleNodeFragment;
        }>;
    };
};
export declare type LoadBlogsQueryVariables = Exact<{
    first: Scalars['Int'];
    after?: Maybe<Scalars['String']>;
}>;
export declare type LoadBlogsQuery = {
    blogs: {
        pageInfo: Pick<PageInfo, 'hasNextPage'>;
        edges: Array<Pick<BlogEdge, 'cursor'> & {
            node: BlogNodeFragment;
        }>;
    };
};
export declare type LoadCollectionsQueryVariables = Exact<{
    first: Scalars['Int'];
    after?: Maybe<Scalars['String']>;
}>;
export declare type LoadCollectionsQuery = {
    collections: {
        pageInfo: Pick<PageInfo, 'hasNextPage'>;
...
export declare type LoadCollectionsByIdsQueryVariables = Exact<{
    ids: Array<Scalars['ID']>;
}>;
export declare type LoadCollectionsByIdsQuery = {
    nodes: Array<Maybe<CollectionNodeFragment>>;
};
export declare type LoadPagesQueryVariables = Exact<{
    first: Scalars['Int'];
    after?: Maybe<Scalars['String']>;
}>;
export declare type LoadPagesQuery = {
    pages: {
        pageInfo: Pick<PageInfo, 'hasNextPage'>;
        edges: Array<Pick<PageEdge, 'cursor'> & {
            node: PageNodeFragment;
        }>;
    };
};
export declare type LoadProductsQueryVariables = Exact<{
    first: Scalars['Int'];
    after?: Maybe<Scalars['String']>;
}>;
export declare type LoadProductsQuery = {
    products: {
        pageInfo: Pick<PageInfo, 'hasNextPage'>;
...
export declare type LoadProductsByIdsQueryVariables = Exact<{
    ids: Array<Scalars['ID']>;
}>;
export declare type LoadProductsByIdsQuery = {
    nodes: Array<Maybe<ProductNodeFragment>>;
};
export declare type LoadShopQueryVariables = Exact<{
    [key: string]: never;
}>;
export declare type LoadShopQuery = {
    shop: {
